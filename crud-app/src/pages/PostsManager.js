...
// When the component first mounts, you won’t have any data yet. You may want some 
// indicator that the page is still loading, so setting the state to loading: true 
// lets you know that later on. Setting the initial posts to an empty array makes the 
// code simpler later since you can just always assume you have an array, even if it’s empty. 
...
class PostsManager extends Component {
    ...
    // This also sets some headers to tell the backend that any body it sends will be in JSON format,
    //  and it sets the authorization header by fetching the access token from Okta.
